...
struct DesX {
    ...
    private static func hexToBt64(_ hex: String) -> String {
        ...
        for i in 0 ..< 16 {
            ...
            binary += DesX.hexToBt4(String(hex[index]))
        }
        return binary
    }
    ...
    private static func enc(_ dataByte: [Int8], _ keyByte: [Int8]) -> [Int8] {
        ...
        for i in 0 ..< 16 {
            ...
            let tempRight = DesX.xor(DesX.pPermute(DesX.sBoxPermute(DesX.xor(DesX.expandPermute(ipRight), key))), tempLeft)
            for n in 0 ..< 32 {
        ...
        return DesX.finallyPermute(finalData)
    }
    ...
    private static func sBoxPermute(_ expandByte: [Int8]) -> [Int8] {
        ...
        for m in 0 ..< 8 {
            ...
            switch m {
            case 0:
                binary = DesX.getBoxBinary(Int8(s1[Int(i)][Int(j)]))
            case 1:
                binary = DesX.getBoxBinary(Int8(s2[Int(i)][Int(j)]))
            case 2:
                binary = DesX.getBoxBinary(Int8(s3[Int(i)][Int(j)]))
            case 3:
                binary = DesX.getBoxBinary(Int8(s4[Int(i)][Int(j)]))
            case 4:
                binary = DesX.getBoxBinary(Int8(s5[Int(i)][Int(j)]))
            case 5:
                binary = DesX.getBoxBinary(Int8(s6[Int(i)][Int(j)]))
            case 6:
                binary = DesX.getBoxBinary(Int8(s7[Int(i)][Int(j)]))
            case 7:
                binary = DesX.getBoxBinary(Int8(s8[Int(i)][Int(j)]))
            default:
                break
            }
