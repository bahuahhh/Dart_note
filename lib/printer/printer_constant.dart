...
class PrinterTicketEunm {
  ...
  static int getIndex(String name) {
    return PrinterTicketEunm.getValues().keys.firstWhere((key) => (PrinterTicketEunm.getValues()[key]) == PrinterTicketEunm.fromName("$name"), orElse: () => 0);
  }
...
class PrinterModelEunm {
  ...
  static int getIndex(String name) {
    return PrinterModelEunm.getValues().keys.firstWhere((key) => (PrinterModelEunm.getValues()[key]) == PrinterModelEunm.fromName("$name"), orElse: () => 0);
  }
...
class PrinterPortEunm {
  ...
  static int getIndex(String name) {
    return PrinterPortEunm.getValues().keys.firstWhere((key) => (PrinterPortEunm.getValues()[key]) == PrinterPortEunm.fromName("$name"), orElse: () => 0);
  }
...
class PrinterEmbedEunm {
  ...
  static int getIndex(String name) {
    return PrinterEmbedEunm.getValues().keys.firstWhere((key) => (PrinterEmbedEunm.getValues()[key]) == PrinterEmbedEunm.fromName("$name"), orElse: () => 0);
  }
...
class PrinterPagerEunm {
  ...
  static int getIndex(String value) {
    return PrinterPagerEunm.getValues().keys.firstWhere((key) => (PrinterPagerEunm.getValues()[key]) == PrinterPagerEunm.fromValue("$value"), orElse: () => 0);
  }
...
class PrinterCutEunm {
  ...
  static int getIndex(String name) {
    return PrinterCutEunm.getValues().keys.firstWhere((key) => (PrinterCutEunm.getValues()[key]) == PrinterCutEunm.fromName("$name"), orElse: () => 0);
  }
...
class PrinterBarcodeEunm {
  ...
  static int getIndex(String value) {
    return PrinterBarcodeEunm.getValues().keys.firstWhere((key) => (PrinterBarcodeEunm.getValues()[key]) == PrinterBarcodeEunm.fromValue("$value"), orElse: () => 0);
  }
...
class PrinterQRCodeEunm {
  ...
  static int getIndex(String value) {
    return PrinterQRCodeEunm.getValues().keys.firstWhere((key) => (PrinterQRCodeEunm.getValues()[key]) == PrinterQRCodeEunm.fromValue("$value"), orElse: () => 0);
  }
...
class PrinterHeaderLineEunm {
  ...
  static int getIndex(String value) {
    return PrinterHeaderLineEunm.getValues().keys.firstWhere((key) => (PrinterHeaderLineEunm.getValues()[key]) == PrinterHeaderLineEunm.fromValue("$value"), orElse: () => 0);
  }
...
class PrinterFooterLineEunm {
  ...
  static int getIndex(String value) {
    return PrinterFooterLineEunm.getValues().keys.firstWhere((key) => (PrinterFooterLineEunm.getValues()[key]) == PrinterFooterLineEunm.fromValue("$value"), orElse: () => 0);
  }
