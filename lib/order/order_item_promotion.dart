...
class OrderItemPromotion extends Equatable {
  ...
  String get displayReason {
    ...
    } else if (this.promotionType == PromotionType.ProductBargain || this.promotionType == PromotionType.OrderBargain) {
      result = sprintf("%s%s", ["(议)", this.reason]);
    } else if (this.promotionType == PromotionType.ProductDiscount || this.promotionType == PromotionType.OrderDiscount) {
  ...
  factory OrderItemPromotion.fromJson(Map<String, dynamic> map) {
    return OrderItemPromotion()
      ...
      ..promotionType = PromotionType.fromValue(Convert.toStr(map["promotionType"]))
      ...
      ..enabled = map["enabled"] is bool ? (map["enabled"] ? 1 : 0) : Convert.toInt(map["enabled"])
