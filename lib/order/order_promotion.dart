...
class OrderPromotion extends Equatable {
  ...
  String limitDate = DateTimeUtils.formatDate(DateTime.now(), format: "yyyy-MM-dd HH:mm:ss");
  ...
  factory OrderPromotion.newOrderPromotion() {
    return OrderPromotion()
      ...
      ..limitDate = DateTimeUtils.formatDate(DateTime.now(), format: "yyyy-MM-dd HH:mm:ss")
      ..ext1 = ""
      ..ext2 = ""
      ..ext3 = ""
