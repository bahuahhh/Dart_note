...
class OrderPay {
  ...
  String payTime = DateTimeUtils.formatDate(DateTime.now(), format: "yyyy-MM-dd HH:mm:ss");
  ...
  factory OrderPay.fromPayMode(OrderObject orderObject, PayMode payMode) {
    return OrderPay()
      ...
      ..bankType = ""
      ..memo = ""
      ..payTime = DateTimeUtils.formatDate(DateTime.now(), format: "yyyy-MM-dd HH:mm:ss")
  ...
  factory OrderPay.fromJson(Map<String, dynamic> map) {
    return OrderPay()
      ...
      ..refundAmount = Convert.toDouble(map["ramount"]) //数据库设计的坑，字段不是refundAmount
