...
import 'package:estore_app/enums/order_point_deal_status.dart';
import 'package:estore_app/enums/order_print_status_type.dart';
...
class OrderObject extends Equatable {
  ...
  String finishDate = DateTimeUtils.formatDate(DateTime.now(), format: "yyyy-MM-dd HH:mm:ss");
  ...
  factory OrderObject.newOrderObject() {
    return OrderObject()
      ...
      ..saleDate = DateTimeUtils.formatDate(DateTime.now(), format: "yyyy-MM-dd HH:mm:ss")
      ..tableId = ""
      ..tableNo = ""
      ..tableName = ""
      ..salesCode = ""
      ...
      ..ipAddress = ""
      ..weather = ""
      ..weeker = DateTimeUtils.getZHWeekDay(DateTime.now())
      ...
      ..serverId = ""
      ..remark = ""
      ..finishDate = DateTimeUtils.formatDate(DateTime.now(), format: "yyyy-MM-dd HH:mm:ss")
      ..isPlus = 0
      ..ext1 = ""
      ..ext2 = ""
      ..ext3 = ""
  ...
  factory OrderObject.fromMap(Map<String, dynamic> map) {
    OrderObject orderObject = OrderObject()
      ...
      ..cashierAction = CashierAction.fromValue(Convert.toStr(map["cashierAction"]))
      ...
      ..paymentStatus = OrderPaymentStatus.fromValue(Convert.toStr(map["paymentStatus"]))
      ..printStatus = OrderPrintStatus.fromValue(Convert.toStr(map["printStatus"]))
      ..printTimes = Convert.toInt(map["printTimes"])
      ..items = map["items"] != null ? List<OrderItem>.from(List<Map<String, dynamic>>.from(map["items"] is String ? json.decode(map["items"]) : map["items"]).map((x) => OrderItem.fromJson(x))) : <OrderItem>[]
      ..itemCount = Convert.toInt(map["itemCount"])
      ..totalQuantity = Convert.toDouble(map["totalQuantity"])
      ..amount = Convert.toDouble(map["amount"])
      ..pays = map["pays"] != null ? List<OrderPay>.from(List<Map<String, dynamic>>.from(map["pays"] is String ? json.decode(map["pays"]) : map["pays"]).map((x) => OrderPay.fromJson(x))) : <OrderPay>[]
      ..payCount = Convert.toInt(map["payCount"])
      ..promotions = map["promotions"] != null ? List<OrderPromotion>.from(List<Map<String, dynamic>>.from(map["promotions"] is String ? json.decode(map["promotions"]) : map["promotions"]).map((x) => OrderPromotion.fromJson(x))) : <OrderPromotion>[]
      ...
      ..receivableRemoveCouponAmount = Convert.toDouble(map["receivableRemoveCouponAmount"])
      ...
      ..refundStatus = OrderRefundStatus.fromValue(Convert.toStr(map["refundStatus"]))
    ...
    if (map["member"] != null) {
      orderObject.member = Member.fromJson(map["member"] is String ? json.decode(map["member"]) : map["member"]);
    }
  ...
  factory OrderObject.clone(OrderObject obj) {
    return OrderObject()
      ...
      ..promotions = obj.promotions.map((item) => OrderPromotion.clone(item)).toList()
      ..member = obj.member
