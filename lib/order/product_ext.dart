...
import 'package:estore_app/entity/pos_promotion_product.dart';
import 'package:estore_app/entity/pos_setmeal_group.dart';
...
class ProductExt {
  ...
  static final String columnSpecialPriceLimitDateDesc = "specialPriceLimitDateDesc";
  ...
  factory ProductExt.fromMap(Map<String, dynamic> map) {
    return ProductExt()
      ...
      ..specialPriceLimitDateDesc = Convert.toStr(map[columnSpecialPriceLimitDateDesc])
