...
class AssistantUtils {
  ...
  Future<Tuple2<bool, String>> printPrePay(Map<String, dynamic> map) async {
    ...
    try {
      ...
      String errorCode = (responseBody != null && responseBody.containsKey("code") ? Convert.toStr(responseBody["code"]) : "");
      String errorMessage = (responseBody != null && responseBody.containsKey("msg") ? Convert.toStr(responseBody["msg"]) : "缺失[msg]参数");
  ...
  ///赠菜
  Future<Tuple3<bool, String, OrderObject>> giftItem(Map<String, dynamic> map) async {
    bool result = false;
    String message = "";
    OrderObject data;
    try {
  ...
  ///退菜
  Future<Tuple3<bool, String, OrderObject>> returnItem(Map<String, dynamic> map) async {
    bool result = false;
    String message = "";
    OrderObject data;
    try {
  ...
  ///点菜宝开台
  Future<Tuple3<bool, String, OrderObject>> openTable(Map<String, dynamic> map) async {
    bool result = false;
    String message = "";
    OrderObject data;
    try {
  ...
  ///获取桌台订单信息
  Future<Tuple3<bool, String, OrderObject>> getOrderObject(String orderId) async {
    bool result = false;
    String message = "";
    OrderObject data;
    try {
