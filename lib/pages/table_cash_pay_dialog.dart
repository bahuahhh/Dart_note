...
///现金支付方式
class TableCashPayDialog extends StatefulWidget {
  final String title;
  ...
  TableCashPayDialog(this.title, this.orderObject, this.payMode, {this.onAccept, this.onClose});

  @override
  _TableCashPayDialogState createState() => _TableCashPayDialogState();
}

class _TableCashPayDialogState extends State<TableCashPayDialog> with SingleTickerProviderStateMixin {
  //输入框
