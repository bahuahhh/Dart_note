...
class AssistantOrderDiscountDialog extends StatefulWidget {
  // 订单对象
  ...
  AssistantOrderDiscountDialog(this.orderObject, this.permissionCode, {this.onAccept, this.onClose});

  @override
  _AssistantOrderDiscountDialogState createState() => _AssistantOrderDiscountDialogState();
}

class _AssistantOrderDiscountDialogState extends State<AssistantOrderDiscountDialog> with SingleTickerProviderStateMixin {
  ///操作员工号
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                Text("折扣原因", style: TextStyles.getTextStyle(fontSize: 32)),
                Space(height: Constants.getAdapterHeight(20)),
                Expanded(
          ...
          FlatButton(
            ...
            onPressed: () {
              ...
              var args = new TableDiscountArgs(orderObject, 0, "", restoreOriginalPrice: true);
      ...
      child: TextFormField(
        ...
        onFieldSubmitted: (inputValue) async {
          ...
          if (StringUtils.isBlank(inputValue)) {
            ToastUtils.show("请输入商品折扣");
            FocusScope.of(context).requestFocus(_focus);
            return;
          }
          //期望的折扣率
          var discountRate = Convert.toDouble(inputValue);
          if (discountRate < 0) {
          ...
          var permissionAction = (permission) {
            var args = new TableDiscountArgs(orderObject, discountRate, "${state.reasonSelected.name}");
            if (widget.onAccept != null) {
              widget.onAccept(args);
            }
          };
          AuthzUtils.instance.checkAuthz(this.context, ModuleKeyCode.$_118, widget.permissionCode, widget.orderObject, permissionAction, expectDiscountRate: discountRate);
        },
      ),
    );
  }
        ...
        children: <Widget>[
          Expanded(
            child: Container(
              ...
              child: Text("整单折扣", style: TextStyles.getTextStyle(color: Constants.hexStringToColor("#333333"), fontSize: 32, fontWeight: FontWeight.bold)),
            ),
          ),
          InkWell(
            onTap: () {
