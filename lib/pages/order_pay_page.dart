...
class OrderPayPage extends StatefulWidget {
  ...
  OrderPayPage(this.title, this.orderObject, this.payMode, {this.onAccept, this.onClose});

  @override
  _OrderPayPageState createState() => _OrderPayPageState();
}

class _OrderPayPageState extends State<OrderPayPage> with SingleTickerProviderStateMixin {
  //输入框
    ...
    return ConstrainedBox(
      ...
      child: TextFormField(
        ...
        onChanged: (inputValue) {
          ...
          //现金支付试算找零
          if (widget.payMode.no == Constants.PAYMODE_CODE_CASH) {
            this._cashierBloc.add(TryChangeAmount(inputAmount));
          }
        },
