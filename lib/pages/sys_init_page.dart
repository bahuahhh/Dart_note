import 'package:estore_app/blocs/sys_init_bloc.dart';
...
class _SysInitPageState extends State<SysInitPage> with SingleTickerProviderStateMixin {
  ///激活码焦点
        ...
        body: BlocListener<SysInitBloc, SysInitState>(
          ...
          listener: (context, state) {
            if (state.status == SysInitStatus.Loading) {
              ...
              Future.delayed(Duration(milliseconds: 100)).then((e) {
                NavigatorUtils.instance.push(context, RouterManager.REGISTER_PAGE, replace: true, clearStack: true);
              });
            }
          },
