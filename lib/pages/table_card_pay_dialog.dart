...
///会员支付方式
class TableCardPayDialog extends StatefulWidget {
  final String title;
  ...
  TableCardPayDialog(this.title, this.orderObject, this.payMode, {this.onAccept, this.onClose});

  @override
  _TableCardPayDialogState createState() => _TableCardPayDialogState();
}

class _TableCardPayDialogState extends State<TableCardPayDialog> with SingleTickerProviderStateMixin {
  //输入框
