...
//构建其他支付方式
class TableOtherPayDialog extends StatefulWidget {
  final String title;
  ...
  TableOtherPayDialog(this.title, this.orderObject, this.payMode, {this.onAccept, this.onClose});

  @override
  _TableOtherPayDialogState createState() => _TableOtherPayDialogState();
}

class _TableOtherPayDialogState extends State<TableOtherPayDialog> with SingleTickerProviderStateMixin {
  //输入框
