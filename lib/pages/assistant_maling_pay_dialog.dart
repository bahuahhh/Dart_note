...
//构建手工抹零支付方式
class AssistantMalingPayDialog extends StatefulWidget {
  final String title;
  ...
  AssistantMalingPayDialog(this.title, this.orderObject, this.payMode, {this.onAccept, this.onClose});

  @override
  _AssistantMalingPayDialogState createState() => _AssistantMalingPayDialogState();
}

class _AssistantMalingPayDialogState extends State<AssistantMalingPayDialog> with SingleTickerProviderStateMixin {
  //输入框
