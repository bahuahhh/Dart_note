...
class AssistantQuantityDialog extends StatefulWidget {
  ...
  AssistantQuantityDialog(this.currentOrderItem, {this.minValue, this.maxValue, this.step, this.fractionDigits, this.onAccept, this.onClose});

  @override
  _AssistantQuantityDialogState createState() => _AssistantQuantityDialogState();
}

class _AssistantQuantityDialogState extends State<AssistantQuantityDialog> with SingleTickerProviderStateMixin {
  //输入
