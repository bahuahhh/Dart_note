...
class AssistantOrderBargainDialog extends StatefulWidget {
  // 订单对象
  ...
  AssistantOrderBargainDialog(this.orderObject, this.permissionCode, {this.onAccept, this.onClose});

  @override
  _AssistantOrderBargainDialogState createState() => _AssistantOrderBargainDialogState();
}

class _AssistantOrderBargainDialogState extends State<AssistantOrderBargainDialog> with SingleTickerProviderStateMixin {
  ///操作员工号
