...
class TableOrderDiscountDialog extends StatefulWidget {
  // 订单对象
  ...
  TableOrderDiscountDialog(this.orderObject, this.permissionCode, {this.onAccept, this.onClose});

  @override
  _TableOrderDiscountDialogState createState() => _TableOrderDiscountDialogState();
}

class _TableOrderDiscountDialogState extends State<TableOrderDiscountDialog> with SingleTickerProviderStateMixin {
  ///操作员工号
