...
class TableRefundQuantityDialog extends StatefulWidget {
  // 订单对象
  ...
  TableRefundQuantityDialog(this.orderObject, this.orderItem, this.permissionCode, {this.onAccept, this.onClose});

  @override
  _TableRefundQuantityDialogState createState() => _TableRefundQuantityDialogState();
}

class _TableRefundQuantityDialogState extends State<TableRefundQuantityDialog> with SingleTickerProviderStateMixin {
