    ...
    return KeyboardDismissOnTap(
      child: Scaffold(
        ...
        appBar: AppBar(
          title: new Text(
            "产品授权",
            style: TextStyles.getTextStyle(color: Constants.hexStringToColor("#FFFFFF"), fontSize: 48),
          ),
          centerTitle: true,
        ),
        body: BlocListener(
          ...
          listener: (context, state) {
            if (state.status == RegisterStatus.Loading) {
              ...
              Future.delayed(Duration(milliseconds: 100)).then((e) {
                var title = "授权信息确认";
                var info = "门店编号：${state.registrationCode.storeNo}\n\n门店名称：${state.registrationCode.storeName}";
              ...
              Future.delayed(Duration(milliseconds: 100)).then((e) {
                NavigatorUtils.instance.push(context, RouterManager.LOGIN_PAGE, replace: true);
              });
            }
          },
                    ...
                    children: <Widget>[
                      Center(
                        child: Text(
                          ...
                          style: TextStyles.getTextStyle(color: Constants.hexStringToColor("#7A73C7"), fontSize: 48),
                        ),
                      ),
                      ...
                      Center(
                        child: Text(
                          "本操作需要手机连接Internet网络",
                          style: TextStyles.getTextStyle(color: Constants.hexStringToColor("#FF8159"), fontSize: 32),
                        ),
                      ),
