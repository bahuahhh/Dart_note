...
import 'package:estore_app/pages/printer_page.dart';
...
import 'assistant_parameter.dart';
import 'maling_page.dart';
              ...
              children: [
                    ...
                    children: [
                      InkWell(
                        ...
                        child: SizedBox(
                          ...
                          child: Icon(Icons.arrow_back_ios, size: Constants.getAdapterWidth(48), color: Constants.hexStringToColor("#2B2B2B")),
                        ),
                      ),
                      Text(
                        "参数设置",
                ...
                Expanded(
                  child: CashierVerticalTabs(
                    ...
                    selectedTabBackgroundColor: Constants.hexStringToColor("#D2D2D2"),
                    tabsShadowColor: Constants.hexStringToColor("#D2D2D2"),
                    indicatorColor: Colors.green,
                    disabledChangePageFromContentView: true,
                    changePageDuration: const Duration(milliseconds: 5),
                    tabTextStyle: TextStyles.getTextStyle(color: Constants.hexStringToColor("#91939C"), fontSize: 28),
                    tabTextAlignment: TabTextAlignment.center,
                    selectedTabTextStyle: TextStyles.getTextStyle(color: Constants.hexStringToColor("#333333"), fontSize: 28, fontWeight: FontWeight.bold),
