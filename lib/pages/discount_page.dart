...
class DiscountPage extends StatefulWidget {
  ...
  DiscountPage(this.orderObject, this.orderItem, this.permissionCode, {this.onAccept, this.onClose});

  @override
  _DiscountPageState createState() => _DiscountPageState();
}

class _DiscountPageState extends State<DiscountPage> with SingleTickerProviderStateMixin {
  ///操作员工号
        ...
        children: <Widget>[
          ...
          FlatButton(
            ...
            onPressed: () {
              ...
              var args = new DiscountArgs(orderItem, 0, "${cashierState.reasonSelected.name}", restoreOriginalPrice: true);
      ...
      child: TextFormField(
        ...
        onFieldSubmitted: (inputValue) async {
          ...
          var permissionAction = (permission) {
            var args = new DiscountArgs(orderItem, discountRate, "${cashierState.reasonSelected.name}");
            if (widget.onAccept != null) {
              widget.onAccept(args);
            }
          };
          ...
          // if (StringUtils.isBlank(inputValue)) {
          //   ToastUtils.show("请输入单品折扣...", position: ToastPosition.center);
          //   FocusScope.of(context).requestFocus(_focus);
          // } else {
          //   // if (widget.onAccept != null) {
        ...
        children: <Widget>[
          Expanded(
            child: Container(
              ...
              child: Text("折扣", style: TextStyles.getTextStyle(color: Constants.hexStringToColor("#FFFFFF"), fontSize: 32)),
            ),
          ),
          InkWell(
            onTap: () {
