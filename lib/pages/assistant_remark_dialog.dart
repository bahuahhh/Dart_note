...
class AssistantRemarkDialog extends StatefulWidget {
  // 订单对象
  ...
  AssistantRemarkDialog(this.orderObject, {this.onAccept, this.onClose});

  @override
  _AssistantRemarkDialogState createState() => _AssistantRemarkDialogState();
}

class _AssistantRemarkDialogState extends State<AssistantRemarkDialog> with SingleTickerProviderStateMixin {
