...
class TableGiftDialog extends StatefulWidget {
  // 订单对象
  ...
  TableGiftDialog(this.orderObject, this.orderItem, this.permissionCode, {this.onAccept, this.onClose});

  @override
  _TableGiftDialogState createState() => _TableGiftDialogState();
}

class _TableGiftDialogState extends State<TableGiftDialog> with SingleTickerProviderStateMixin {
