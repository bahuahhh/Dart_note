...
//构建其他支付方式
class AssistantOtherPayDialog extends StatefulWidget {
  final String title;
  ...
  AssistantOtherPayDialog(this.title, this.orderObject, this.payMode, {this.onAccept, this.onClose});

  @override
  _AssistantOtherPayDialogState createState() => _AssistantOtherPayDialogState();
}

class _AssistantOtherPayDialogState extends State<AssistantOtherPayDialog> with SingleTickerProviderStateMixin {
  //输入框
