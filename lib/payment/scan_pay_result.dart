...
class ScanPayResult {
  ...
  factory ScanPayResult.fromLeShuaPaymentResult(LeShuaPaymentResult obj, String tradeNo, PayMode payMode) {
    ...
    return ScanPayResult()
      ...
      ..platformPaid = success ? Convert.toDouble(obj.buyer_pay_amount) / 100 : 0
      ..platformDiscount = success ? Convert.toDouble(obj.discount_amount) / 100 : 0
  ...
  factory ScanPayResult.fromLeShuaQueryResult(LeShuaQueryResult obj, String tradeNo, PayMode payMode) {
    bool success = (obj.status == "2");
    return ScanPayResult()
      ..success = success
      ..tradeNo = tradeNo
  ...
  factory ScanPayResult.fromSaobeiPaymentResult(SaobeiPaymentResult obj, String tradeNo, PayMode payMode) {
  ...
  factory ScanPayResult.fromSaobeiQueryResult(SaobeiQueryResult obj, String tradeNo, PayMode payMode) {
  ...
  factory ScanPayResult.fromSaobeiRefundResult(SaobeiPaymentResult obj, String tradeNo, PayMode payMode) {
    bool success = (obj.result_code == "01" || obj.result_code == "03");
    return ScanPayResult()
      ..success = success
      ..tradeNo = tradeNo
  ...
  factory ScanPayResult.fromXiaobeiPaymentResult(XiaobeiPaymentResult obj, String tradeNo, PayMode payMode) {
    ...
    return ScanPayResult()
      ...
      ..platformDiscount = success ? Convert.toDouble(obj.trade_amount) / 100 : 0
      ..payType = payMode.no /**这里需要支付方式编号*/
  ...
  factory ScanPayResult.fromXiaoaobeiQueryResult(XiaobeiQueryResult obj, String tradeNo, PayMode payMode) {
    bool success = (obj.errcode == "0");
    return ScanPayResult()
      ..success = success
      ..tradeNo = tradeNo
  ...
  factory ScanPayResult.fromXiaobeiRefundResult(XiaobeiRefundResult obj, String tradeNo, PayMode payMode) {
    bool success = (obj.errcode == "0");
    return ScanPayResult()
      ..success = success
      ..tradeNo = tradeNo
