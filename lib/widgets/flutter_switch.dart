...
class FlutterSwitch extends StatefulWidget {
  ...
  const FlutterSwitch({Key key, this.value, this.onToggle, this.activeColor = Colors.blue, this.inactiveColor = Colors.grey, this.activeTextColor = Colors.white70, this.inactiveTextColor = Colors.white70, this.toggleColor = Colors.white, this.width = 70.0, this.height = 35.0, this.toggleSize = 25.0, this.valueFontSize = 16.0, this.borderRadius = 20.0, this.padding = 4.0, this.showOnOff = false, this.activeText, this.inactiveText}) : super(key: key);
  ...
  Widget get _activeText {
    if (widget.showOnOff) {
      return Text(
        ...
        style: TextStyles.getTextStyle(color: widget.activeTextColor, fontSize: widget.valueFontSize),
      );
    }
  ...
  Widget get _inactiveText {
    if (widget.showOnOff) {
      return Text(
        ...
        style: TextStyles.getTextStyle(color: widget.inactiveTextColor, fontSize: widget.valueFontSize),
      );
    }
