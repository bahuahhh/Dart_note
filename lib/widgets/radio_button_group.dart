...
class _RadioButtonGroupState extends State<RadioButtonGroup> {
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; i < widget.labels.length; i++) {
      ...
      Text t = Text(widget.labels.elementAt(i), overflow: TextOverflow.ellipsis, style: (widget.disabled != null && widget.disabled.contains(widget.labels.elementAt(i))) ? widget.labelStyle.apply(color: Theme.of(context).disabledColor) : widget.labelStyle);
