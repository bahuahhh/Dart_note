...
class _CashierVerticalTabs extends State<CashierVerticalTabs> with TickerProviderStateMixin {
  int _selectedIndex;
                        ...
                        children: <Widget>[
                          Expanded(
                            child: ListView.builder(
                              itemExtent: widget.tabsHeight, //zhangy 2020-02-19 Add 左侧高度
                              ...
                              itemBuilder: (context, index) {
                                ...
                                if (widget.tabTextAlignment == TabTextAlignment.left) {
                                  alignment = Alignment.centerLeft;
                                  crossAxisAlignment = CrossAxisAlignment.start;
                                } else if (widget.tabTextAlignment == TabTextAlignment.right) {
                                ...
                                if (tab.child != null) {
                                  ...
                                  child = Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: <Widget>[
                                          (tab.icon != null) ? Column(children: <Widget>[LoadAssetImage(tab.icon, format: tab.format, color: _selectedIndex == index ? widget.selectedTabTextStyle.color : widget.tabTextStyle.color, width: Constants.getAdapterWidth(30), height: Constants.getAdapterHeight(30)), Space(height: Constants.getAdapterHeight(8))]) : Container(),
                                          (tab.text != null) ? Container(alignment: alignment, width: widget.tabsWidth, child: Text(tab.text, softWrap: true, style: _selectedIndex == index ? widget.selectedTabTextStyle : widget.tabTextStyle)) : Container(),
                                        ],
                                      ));
                                }
                                    ...
                                    GestureDetector(
                                      ...
                                      child: Container(
                                        decoration: BoxDecoration(
                                          ...
                                          border: Border(bottom: BorderSide(width: 1, color: widget.tabsShadowColor)),
                                        ),
                                        alignment: alignment,
                          ...
                          widget.expandTabs != null ? widget.expandTabs : Container(),
                        ],
                      ),
                    ),
