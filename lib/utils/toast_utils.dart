...
import 'package:estore_app/enums/notify_type.dart';
...
class ToastUtils {
  static ToastFuture notify(
    ...
    var widget = Center(
      child: Container(
        ...
        child: Column(
          children: <Widget>[
            Image.asset(imgName, width: Constants.getAdapterWidth(64), height: Constants.getAdapterHeight(64)),
  ...
  static show(
    ...
    showToast(
      ...
      textStyle: textStyle ?? TextStyles.getTextStyle(color: Colors.white, fontSize: 32),
