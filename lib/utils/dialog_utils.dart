...
class DialogUtils {
  ...
  static void setupLoadingWidget() {
    ...
    EasyLoading.instance.contentPadding = Constants.paddingSymmetric(vertical: 15.0, horizontal: 20.0);
  }

  ///确认对话框
  static YYDialog confirm(BuildContext context, String title, String info, Function ok, Function cancel, {double width = 400}) {
    return YYDialog().build(context)
      ...
      ..divider()
      ..text(
        padding: Constants.paddingOnly(left: 18.0, right: 18.0, bottom: 32.0, top: 24.0),
        text: "$info",
        fontFamily: "Alibaba PuHuiTi",
        color: Colors.black,
        fontSize: Constants.getAdapterFontSize(32),
  ...
  ///通知对话框
  static YYDialog notify(BuildContext context, String title, String info, Function ok, {String buttonText = "确定", double width = 400}) {
    return YYDialog().build(context)
      ..width = Constants.getAdapterWidth(width)
      ..borderRadius = 4.0
      ..barrierDismissible = false
  ...
  static YYDialog showDialog(BuildContext context, Widget child, {double width = 410, double height = 546, bool barrierDismissible = false}) {
    return YYDialog().build(context)
      ..width = Constants.getAdapterWidth(width)
