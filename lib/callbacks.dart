...
///授权
typedef PermissionAction = void Function(Tuple4<double, double, List<String>, Worker>);

///扫码支付回调
typedef OnPaymentCallback = void Function(OrderObject orderObject, ScanPayResult payResult);
...
class BargainArgs extends AcceptArgs {
  ...
  BargainArgs(this.orderItem, this.inputValue, this.reason, {this.restoreOriginalPrice = false});
...
class DiscountArgs extends AcceptArgs {
  ...
  final String reason;
  final bool restoreOriginalPrice;
  DiscountArgs(this.orderItem, this.inputValue, this.reason, {this.restoreOriginalPrice = false});
...
class TableGiftArgs extends AcceptArgs {
  ...
  TableGiftArgs(this.orderItem, this.giftQuantity, this.giftReason, {this.cancelGift = false});
...
class TableRefundQuantityArgs extends AcceptArgs {
  ...
  TableRefundQuantityArgs(this.orderItem, this.refundQuantity, this.refundReason);
...
class TableBargainArgs extends AcceptArgs {
  ...
  final bool restoreOriginalPrice;
  TableBargainArgs(this.orderObject, this.inputAmount, this.bargainReason, {this.restoreOriginalPrice = false});
...
class TableDiscountArgs extends AcceptArgs {
  ...
  final bool restoreOriginalPrice;
  TableDiscountArgs(this.orderObject, this.discountRate, this.discountReason, {this.restoreOriginalPrice = false});
