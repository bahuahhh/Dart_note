...
class Skin {
  ...
  Skin({
    ...
    this.options,
        ...
        this.description = description ?? (data.brightness == Brightness.light ? "Light Theme" : "Dark Theme") {
    ...
    return Skin(
      data: ThemeData(
        ...
        inputDecorationTheme: InputDecorationTheme(
          ...
          hintStyle: TextStyle(color: Constants.hexStringToColor("#999999"), fontSize: 24),
        ),
      ),
