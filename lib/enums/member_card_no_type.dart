  ...
  factory MemberCardNoType.judgeCardWay(String tenantId, String voucherNo) {
    ...
    if (voucherNo != null) {
      if (voucherNo.length == 18) {
        ...
        //手机卡号
        var prefix = voucherNo.substring(0, 2);
        if (prefix == "13" || prefix == "14" || prefix == "15" || prefix == "16" || prefix == "17" || prefix == "18" || prefix == "19") {
          type = MemberCardNoType.Mobile;
        }
      } else if (voucherNo.length == 16 && voucherNo.startsWith(Global.instance.authc.tenantId)) {
        //巨为卡号
