...
class MemberCardRechargeScheme {
  ...
  factory MemberCardRechargeScheme.fromJson(Map<String, dynamic> json) {
    return MemberCardRechargeScheme()
      ...
      ..detailList = json["detailList"] != null ? List<MemberCardRechargeSchemeDetail>.from(json["detailList"].map((x) => MemberCardRechargeSchemeDetail.fromJson(x))) : <MemberCardRechargeSchemeDetail>[];
  }
