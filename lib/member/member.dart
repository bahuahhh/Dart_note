...
import 'package:estore_app/entity/pos_member_level.dart';
import 'package:estore_app/entity/pos_member_tag.dart';
...
class Member extends Equatable {
  ...
  /// 有效计次项目列表
  List<MemberTimesCountProject> timesCountProjectList = <MemberTimesCountProject>[];
  ...
  factory Member.fromJson(Map<String, dynamic> json) {
    return Member()
      ...
      ..plusPriceDiscountAmount = Convert.toDouble(json['plusPirceDiscountAmount']) //plusPirceDiscountAmount单词拼写错误，后台错的
      ...
      ..cardList = json["cardList"] != null ? List<MemberCard>.from(json["cardList"].map((x) => MemberCard.fromJson(x))) : <MemberCard>[]
      ..memberTagList = json["memberTagList"] != null ? List<MemberTag>.from(json["memberTagList"].map((x) => MemberTag.fromMap(x))) : <MemberTag>[]
      ..timesCountProjectList = json["timesCountProjectList"] != null ? List<MemberTimesCountProject>.from(json["timesCountProjectList"].map((x) => MemberTimesCountProject.fromJson(x))) : <MemberTimesCountProject>[];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.timesCountProjectList != null) {
      data['timesCountProjectList'] = this.timesCountProjectList.map((v) => v.toJson()).toList();
    }
